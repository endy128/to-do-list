...
import {
  createProject, createItem, findActiveProject, setActiveProject, allProjects,
} from './index';
...
const pageSetup = () => {
  ...
  const sidebar = divCreate('sidebar');
...
const renderProjForm = () => {
  ...
  const pSubmit = document.createElement('button');
...
const renderItemForm = () => {
  ...
  const itemDesc = document.createElement('input');
  ...
  // create a cancel button
  const iCancel = document.createElement('button');
...
const addEventHandlers = () => {
  ...
  itemSubmitButton.addEventListener('click', () => {
    ...
    if (hiddenFormValue !== 'false') {
      ...
      const newItem = createItem(desc, date, false);
...
const addToggleCheckboxEventHandlers = (() => () => {
  ...
  checkboxes.forEach((checkbox) => checkbox.addEventListener('click', (e) => {
    const { index } = checkbox.parentNode.dataset;
...
export {
  pageSetup, createHtmlItem, renderItem, addEventHandlers, renderProjectList, renderItemsList,
};
